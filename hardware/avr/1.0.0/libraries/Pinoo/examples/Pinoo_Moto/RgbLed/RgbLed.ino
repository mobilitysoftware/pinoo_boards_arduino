 ...
 * 
 * Bu örnek Pinoo Moto kartındaki dahili RGB LED'lerin (D9 pinine bağlı 2 adet)
 * ve harici RGB LED modüllerinin nasıl kontrol edileceğini gösterir.
 * 
 * This example demonstrates how to control the on-board RGB LEDs (2 LEDs on Pin D9)
 * and external RGB LED modules on the Pinoo Moto board.
 */

#include <Pinoo.h>

// Dahili RGB LED'leri başlat (Varsayılan olarak D9 pini ve 2 LED)
// Initialize on-board RGB LEDs (Defaults to Pin D9 and 2 LEDs)
