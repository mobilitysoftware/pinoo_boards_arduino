 ...
 * 
 * Bu örnek Door 4'e bağlı I2C LCD Ekran modülünün kullanımını gösterir.
 * This example demonstrates usage of I2C LCD Screen module connected to Door 4.
 */

#include <Pinoo.h>

// Door 4'e bağlı I2C LCD ekran / I2C LCD screen connected to Door 4 (Hardware I2C)
Pinoo_Lcd lcd(DOOR4);
