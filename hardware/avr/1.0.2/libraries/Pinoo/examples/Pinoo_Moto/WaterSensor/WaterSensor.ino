 ...
 * 
 * Bu örnek Door 3'e bağlı Su Seviyesi Sensörü modülünün kullanımını gösterir.
 * This example demonstrates usage of Water Level Sensor module connected to Door 3.
 */

#include <Pinoo.h>

// Door 3'e bağlı Su Seviyesi Sensörü / Water Level Sensor connected to Door 3 (Analog)
Pinoo_WaterSensor waterSensor(DOOR3);
