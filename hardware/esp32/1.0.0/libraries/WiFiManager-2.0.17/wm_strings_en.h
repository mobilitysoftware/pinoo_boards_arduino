...
"<form action='/wifi'    method='get'><button>WiFi Yapılandır</button></form><br/>\n", // MENU_WIFI
"<form action='/0wifi'   method='get'><button>WiFi Yapılandır (Tarama)</button></form><br/>\n", // MENU_WIFINOSCAN
"<form action='/info'    method='get'><button>Bilgi</button></form><br/>\n", // MENU_INFO
"<form action='/param'   method='get'><button>Kurulum</button></form><br/>\n",//MENU_PARAM
...
const char HTTP_FORM_WIFI[]        PROGMEM = "<label for='s'>SSID</label><input id='s' name='s' maxlength='32' autocorrect='off' autocapitalize='none' placeholder='{v}'><br/><label for='p'>Parola</label><input id='p' name='p' maxlength='64' type='password' placeholder='{p}'><input type='checkbox' onclick='f()'> Parolayı Göster";
...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>Bilgiler Kaydedildi<br/>Pinoo ağa bağlanmaya çalışıyor..<br />Başarısız olursa, tekrar denemek için kartın üzerindeki EN düğmesine basın.</div>";
const char HTTP_PARAMSAVED[]       PROGMEM = "<div class='msg S'>Kaydedildi<br/></div>";
const char HTTP_END[]              PROGMEM = "</div></body></html>";
const char HTTP_ERASEBTN[]         PROGMEM = "<br/><form action='/erase' method='get'><button class='D'>WiFi Ayarları Sil</button></form>";
...
const char HTTP_STATUS_ON[]        PROGMEM = "<div class='msg S'>{v} <strong>Bağlandı</strong><br/><em><small>IP {i}</small></em></div>";
const char HTTP_STATUS_OFF[]       PROGMEM = "<div class='msg {c}'> {v}{r} ağına <strong>Bağlanılamadı</strong></div>"; // {c=class} {v=ssid} {r=status_off}
const char HTTP_STATUS_OFFPW[]     PROGMEM = "<br/>Kimlik Doğrulama Hatası"; // STATION_WRONG_PASSWORD,  no eps32
const char HTTP_STATUS_OFFNOAP[]   PROGMEM = "<br/>Ağ Bulunamadı";   // WL_NO_SSID_AVAIL
const char HTTP_STATUS_OFFFAIL[]   PROGMEM = "<br/>Bağlanılamadı"; // WL_CONNECT_FAILED
const char HTTP_STATUS_NONE[]      PROGMEM = "<div class='msg'>Ağ Tanımlı Değil</div>";
...
const char HTTP_HELP[]             PROGMEM =
 ...
 "<table class='table'>"
 "<thead><tr><th>Sayfa</th><th>Özelliği</th></tr></thead><tbody>"
 "<tr><td><a href='/'>/</a></td>"
 "<td>Menü sayfası.</td></tr>"
 "<tr><td><a href='/wifi'>/wifi</a></td>"
 "<td>WiFi tarama sonuçlarını gösterir ve WiFi yapılandırmasını girer.(/0wifi noscan)</td></tr>"
 "<tr><td><a href='/wifisave'>/wifisave</a></td>"
 "<td>Cihazı yapılandırır ve WiFi yapılandırma bilgilerini kaydeder. Değişkenlerin girilmesine ihtiyaç duyar.</td></tr>"
 "<tr><td><a href='/param'>/param</a></td>"
 "<td>Parametere Sayfası</td></tr>"
 "<tr><td><a href='/info'>/info</a></td>"
 "<td>Bilgilendirme Sayfası</td></tr>"
 "<tr><td><a href='/u'>/u</a></td>"
 "<td>OTA (Firmware) Güncelleme</td></tr>"
 "<tr><td><a href='/close'>/close</a></td>"
 "<td>Ayarlar Sayfasını kapatın, Ayarlar Sayfası aktif kalacaktır.</td></tr>"
 "<tr><td>/exit</td>"
 "<td>Ayarlar Sayfasından çıkış yapar, Ayarlar Sayfası kapanacaktır</td></tr>"
 "<tr><td>/restart</td>"
 "<td>Pinoo'yu Yeniden Başlat</td></tr>"
 "<tr><td>/erase</td>"
 "<td>WiFi yapılandırmasını siler ve Pinoo'yu yeniden başlatır. Pinoo, yeni WiFi yapılandırma verileri girilene kadar bir ağa yeniden bağlanmayacaktır.</td></tr>"
 "</table>"
 "<p/><a href='https://www.atolyevizyon.com/'>Atölye Vizyon</a> - <a href='https://pinoo.io'>Pinoo Robotics</a>";
 //<p/>Github <a href='https://github.com/tzapu/WiFiManager'>https://github.com/tzapu/WiFiManager</a>.";
#else
const char HTTP_HELP[]             PROGMEM = "";
#endif

const char HTTP_UPDATE[] PROGMEM = "Yeni Firmware Yükle<br/><form method='POST' action='u' enctype='multipart/form-data' onchange=\"(function(el){document.getElementById('uploadbin').style.display = el.value=='' ? 'none' : 'initial';})(this)\"><input type='file' name='update' accept='.bin,application/octet-stream'><button id='uploadbin' type='submit' class='h D'>Güncelle</button></form><small><a href='http://192.168.4.1/update' target='_blank'>* Sabit portal içinde çalışmayabilir, Tarayıcıda http://192.168.4.1 adresinden deneyiniz</a><small>";
const char HTTP_UPDATE_FAIL[] PROGMEM = "<div class='msg D'><strong>Güncelleme Başarısız!</strong><Br/>Pinoo'yu yeniden başlatıp tekrar deneyiniz..!</div>";
const char HTTP_UPDATE_SUCCESS[] PROGMEM = "<div class='msg S'><strong>Güncelleme Başarılı.  </strong> <br/> Pinoo yeniden Başlatılıyor...</div>";
...
#else
	const char HTTP_INFO_esphead[]    PROGMEM = "<h3>Pinoo ESP32</h3><hr><dl>";
...
const char HTTP_INFO_aboutver[]     PROGMEM = "<dt>Yapılandırma</dt><dd>{1}</dd>";
const char HTTP_INFO_aboutarduino[] PROGMEM = "<dt>Chip</dt><dd>{1}</dd>";
const char HTTP_INFO_aboutsdk[]     PROGMEM = "<dt>ESP-SDK/IDF</dt><dd>{1}</dd>";
const char HTTP_INFO_aboutdate[]    PROGMEM = "<dt>Yapılandırma Tarihi</dt><dd>{1}</dd>";
