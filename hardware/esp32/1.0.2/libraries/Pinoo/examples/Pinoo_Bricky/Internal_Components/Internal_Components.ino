 ...
 * @brief Bilingual (TR/EN) example for Pinoo Bricky on-board components.
 * 
 * Bu örnek Pinoo Bricky kartındaki dahili LED (D13) ve kızılötesi alıcı (D12)
 * bileşenlerinin kullanımını gösterir.
 * 
 * This example shows the usage of on-board components of Pinoo Bricky:
...
void setup() {
  ...
  Serial.println("Pinoo Bricky Dahili Bilesenler Hazir / Internal Components Ready");
}
